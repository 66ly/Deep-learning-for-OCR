...
class picMat:
    ...
    def __convertMatHelper(self, filename):
    ...
    def __combineTrainMatrix(self, foldername='train/'):
        ...
        for root1 in lst: 
            ...
            for files in os.listdir(foldername+root1+'/'):
                ...
                data = self.__convertMatHelper(foldername+root1+'/'+files)
    ...
    def __CombineTestData(self,foldername='test/'):
        ...
        for files in lst: 
            ...
            data = self.__convertMatHelper(foldername+files)
    ...
    def saveRawTestData(self, X_csvName='x_test.csv', Y_csvName='y_testLabel.csv'):
        x_test, label_y = self.__CombineTestData()
